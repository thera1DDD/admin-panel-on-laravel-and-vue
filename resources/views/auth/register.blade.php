    ...
    <div class="card-body login-card-body">
        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="input-group mb-3">
                <input id="name" type="text" placeholder="Имя" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>                <div class="input-group-append">
        ...
        <p class="mb-0">
            <a href="{{route('login')}}" class="text-center">Уже есть аккаунт?</a>
        </p>
    </div>
    <!-- /.Register-card-body -->
</div>
