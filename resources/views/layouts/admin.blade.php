    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('home')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">DJigitAdmin</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{asset(getImage(auth()->user()->photo) ?? route('login'))}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">{{ auth()->user()->name?? route('login')}}</a>
                    </div>
                </div>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{route('translate.allTranslates')}}" class="nav-link">
                                                <i class="nav-icon fas fa-chalkboard"></i>
                                                <p>
                                                    Переводы словаря
                                                </p>
