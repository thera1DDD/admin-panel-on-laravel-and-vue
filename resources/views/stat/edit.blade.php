            ...
            <div class="row">
                <form action="{{route('stat.update',$stat->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="passed_courses_id"  id="courses_id" class="form-control select2" data-placeholder="Выберите Пользователя" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="passed_modules_id"  id="passed_modules_id" class="form-control select2" data-placeholder="Выберите Пользователя" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="passed_videos_id"  id="passed_videos_id" class="form-control select2" data-placeholder="Выберите видео" style="width: 100%;">
